...
module.exports = function(config) {
  ...
  config.addTransform("respImages", (rawContent, outputPath) => {
    ...
    if (images.length > 0) {
      images.map(img => {
        img.srcset = `https://theformat.app/unsafe/540x0/${img.src} 540w, https://theformat.app/unsafe/536x0/${img.src} 360w, https://theformat.app/unsafe/240x0/${img.src} 240w, https://theformat.app/unsafe/640x0/${img.src} 640w, https://theformat.app/unsafe/980x0/${img.src} 980w, https://theformat.app/unsafe/1140x0/${img.src} 1140w``
